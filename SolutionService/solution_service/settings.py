"""
Django settings for solution_service project.
...
SECRET_KEY = 'django-insecure-q)7s3i5efr*vd75=w9lpoz)4%+2e=33$g#$*edel+o^617a)ht'
...
ROOT_URLCONF = 'solution_service.urls'
...
WSGI_APPLICATION = 'solution_service.wsgi.application'
