...
from contest_service.config import service_config_loader
...
ACCOUNT_SERVICE = config.services.account_service
...
AVAILABLE_COMPILERS = [
    [compiler.id, compiler.syntax_highlighting]
    for compiler in config.app.available_compilers
]

ALLOW_CONTEST_CREATION_TO = config.app.allow_contest_creation_to
