...
urlpatterns = [
    ...
    path('api/contests/<int:pk>/',
         views.RetrieveUpdateDestroyContestView.as_view()),
    path('api/contests/<int:contest_id>/tasks/text/',
         views.ListCreateTextPageView.as_view()),
    path('api/contests/<int:contest_id>/tasks/text/<int:pk>/',
         views.RetrieveUpdateDestroyTextPageView.as_view()),
    path('api/contests/<int:contest_id>/tasks/quiz/',
         views.ListCreateQuizTaskView.as_view()),
    path('api/contests/<int:contest_id>/tasks/quiz/<int:pk>/',
         views.RetrieveUpdateDestroyQuizTaskView.as_view()),
    path('api/contests/<int:contest_id>/tasks/code/',
         views.ListCreateCodeTaskView.as_view()),
    path('api/contests/<int:contest_id>/tasks/code/<int:pk>/',
         views.RetrieveUpdateDestroyCodeTaskView.as_view()),
    path('api/contests/tasks/<str:task_type>/<int:task_id>/can-submit/<int:user_id>/',
